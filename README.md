...
* не более N = 10 попыток в минуту для данного логина. Протекание 1 в минуту.
capacity = 10, rate = 10 minute / capacity
* не более M = 100 попыток в минуту для данного пароля (защита от обратного brute-force).
capacity = 100, rate = 10 minute / capacity
* не более K = 1000 попыток в минуту для данного IP (число большое, т.к. NAT).
capacity = 1000, rate = 10 minute / capacity
503 - превышенное кол-во ошибок
